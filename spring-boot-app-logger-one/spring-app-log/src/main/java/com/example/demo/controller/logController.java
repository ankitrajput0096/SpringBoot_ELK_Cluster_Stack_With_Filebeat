...
public class logController {
    ...
    public ResponseEntity<String> generateLogs() {
        logger.info("This is how we generate logs in spring " +
                "boot application in style from service one.");
        ...
        return ResponseEntity.ok("Awesome!!! we have " +
                "generated logs from service one.");
    }
    ...
    public ResponseEntity<String> generateLogException() {
        try{
            ...
            logger.info("This is how we generate logs from " +
                    "service one via exception api.");
            logger.error("This is error in the service one" +
                    e.getStackTrace().toString());
            return ResponseEntity.badRequest().body("This is a " +
                    "request which results in exception");
        }
        return ResponseEntity.ok("Awesome!!! we have generated " +
                "logs from service one.");
    }
}