...
public class logControllerTwo {
    ...
    private static final Logger logger =
            LoggerFactory.getLogger(logControllerTwo.class);

    @GetMapping("/logTwo")
    public ResponseEntity<String> generateLogs() {
        logger.info("This is how we generate logs in spring boot " +
                "application in style from service two.");
    ...
    public ResponseEntity<String> generateLogException() {
        try{
            ...
            logger.info("This is how we generate logs from service " +
                    "two via exception api.");
            logger.error("This is error in the service two" +
